...
@Suite struct SessionStoreTests {
    @Test func aWaitingQuestionSurvivesARestart() {
        ...
        let url = FileManager.default.temporaryDirectory.appending(path: "nudge-sessions-\(UUID().uuidString).json")
    ...
    @Test mutating func sessionsThatEndedWhileNudgeWasQuitAreDropped() {
