...
@Suite struct SessionReducerTests {
    ...
    @Test mutating func registryAddsSessionsStartedBeforePip() {
...
@Suite struct GitBranchTests {
    func temporaryDirectory() throws -> URL {
        let url = FileManager.default.temporaryDirectory.appending(path: "pip-git-\(UUID().uuidString)", directoryHint: .isDirectory)
