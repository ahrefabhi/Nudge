...
@Suite struct LiveUsageTests {
    ...
    init() throws {
        root = FileManager.default.temporaryDirectory.appending(path: "peeku-live-\(UUID().uuidString)", directoryHint: .isDirectory)
...
@Suite struct OwnHelperTests {
    @Test func aSessionListEntryForPeekusOwnChildIsSkipped() throws {
        let directory = FileManager.default.temporaryDirectory.appending(path: "peeku-registry-\(UUID().uuidString)", directoryHint: .isDirectory)
...
@Suite struct UsageServiceLiveTests {
    ...
    init() throws {
        root = FileManager.default.temporaryDirectory.appending(path: "peeku-usage-live-\(UUID().uuidString)", directoryHint: .isDirectory)
