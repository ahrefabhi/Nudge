...
@Suite struct SessionReducerTests {
    ...
    @Test mutating func registryAddsSessionsStartedBeforePeeku() {
...
@Suite struct GitBranchTests {
    func temporaryDirectory() throws -> URL {
        let url = FileManager.default.temporaryDirectory.appending(path: "peeku-git-\(UUID().uuidString)", directoryHint: .isDirectory)
