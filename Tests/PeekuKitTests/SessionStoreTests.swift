...
@Suite struct SessionStoreTests {
    @Test func aWaitingQuestionSurvivesARestart() {
        ...
        let url = FileManager.default.temporaryDirectory.appending(path: "peeku-sessions-\(UUID().uuidString).json")
    ...
    @Test mutating func sessionsThatEndedWhilePeekuWasQuitAreDropped() {
