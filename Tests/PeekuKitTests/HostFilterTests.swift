...
@Suite struct HostFilterTests {
    ...
    func session(_ id: String, _ host: HostApp, app: (String, String)? = nil) -> PeekuSession {
        PeekuSession(id: id, project: "p", task: "t", host: host, hostAppName: app?.1, hostBundleID: app?.0, kind: .working, since: date)
    }
