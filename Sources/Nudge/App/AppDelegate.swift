...
final class AppDelegate: NSObject, NSApplicationDelegate {
    ...
    private func openedUsageAlert(_ alert: NudgeSession) {
    ...
    private func focus(_ session: NudgeSession) {
        ...
        case .failure(let failure):
            NSLog("Nudge couldn't open %@: %@", session.project, failure.description)
    ...
    private func showAutomationHelp(_ failure: SessionOpener.Failure) {
        let alert = NSAlert()
        alert.messageText = "Nudge needs permission to switch tabs"
