...
public struct AgentUsage: Sendable, Equatable, Identifiable {
    public enum Source: Sendable, Equatable {
        /// Peeku can read this agent's usage.
        case connected
        /// Claude Code only: Peeku isn't its status line yet.
        case needsSetup
        /// Claude Code only: Peeku is its status line, but no session has run it yet.
