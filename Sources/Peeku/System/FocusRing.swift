...
/// After Open Session, outlines the window Peeku just raised: a 2px accent ring that fades in,
...
final class FocusRing {
    ...
    /// The app's focused window in AppKit coordinates: from Accessibility when Peeku is trusted,
