...
/// The app icon: Peeku hanging from a small black notch on a dark tile, like onboarding's hero.
...
struct AppIconView: View {
    ...
    var body: some View {
        ...
        ZStack(alignment: .top) {
            ...
            PeekuView(mood: .working, size: tile * 0.52, extras: false, still: true)
    ...
    static func writeIconset(to directory: URL) throws {
        ...
        for points in [16, 32, 128, 256, 512] {
            for scale in [1, 2] {
                ...
                let renderer = ImageRenderer(content: AppIconView().environment(\.peekuStill, true))
