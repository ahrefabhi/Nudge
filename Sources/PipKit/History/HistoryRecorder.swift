...
public struct HistoryRecorder: Sendable {
    ...
    private var previous: [String: PipSession] = [:]
    ...
    @discardableResult
    public mutating func record(_ sessions: [PipSession], now: Date = Date()) -> Bool {
        ...
        for session in sessions {
            ...
            // A session that was already finished or working when Pip started isn't news.
...
public struct HistoryStore: Sendable {
    ...
    public init(paths: PipPaths = .default) { url = paths.history }
