...
public struct HistoryRecorder: Sendable {
    ...
    private var previous: [String: NudgeSession] = [:]
    ...
    @discardableResult
    public mutating func record(_ sessions: [NudgeSession], now: Date = Date()) -> Bool {
        ...
        for session in sessions {
            ...
            // A session that was already finished or working when Nudge started isn't news.
...
public struct HistoryStore: Sendable {
    ...
    public init(paths: NudgePaths = .default) { url = paths.history }
