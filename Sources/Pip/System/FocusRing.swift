...
/// After Open Session, outlines the window Pip just raised: a 2px accent ring that fades in,
...
final class FocusRing {
    ...
    /// The app's focused window in AppKit coordinates: from Accessibility when Pip is trusted,
