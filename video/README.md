...
The source of the README's launch video: a 21.7-second, 1920×1080 clip of the notch coming alive, Open Session, the moods, the Now and Usage panels, and the outro. [PLAN.md](PLAN.md) has the storyboard.
...
2. Check stills from each scene and mid-transition before a full render:
   ```sh
   cd video && node capture.js stills 2.6 6.5 9.8 13.8 16.5 20.5   # out/stills/
   ```
3. Run `video/render.sh`, optionally with the poster time (default 6.6 s).
